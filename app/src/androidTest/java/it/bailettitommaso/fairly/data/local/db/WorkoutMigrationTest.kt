...
import it.bailettitommaso.fairly.di.MIGRATION_1_2
import it.bailettitommaso.fairly.di.MIGRATION_2_3
...
class WorkoutMigrationTest {
    ...
    fun migratesFromVersion2AndKeepsCachedExercises() = runTest {
        ...
        val database = Room.databaseBuilder(context, FairlyDatabase::class.java, DB_NAME)
